...
class compraAdmin(admin.ModelAdmin):
    ...
    list_display = ['Fecha', 'ProveedoresId','NumCompra','Total','condicionId']
...
class ComprasCreditoAdmin(admin.ModelAdmin):
    search_fields=['id', 'CompraId']
    list_display = [ 'FechaInicioCredito', 'montoTotalCredito', 'saldoPendiente', 'FechaLimiteCredito','estadoCuentaId']